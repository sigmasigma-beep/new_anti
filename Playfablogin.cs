...
public class Playfablogin : MonoBehaviourPunCallbacks
{
    ...
    [Tooltip("Assign parent GameObjects directly. Children are checked by activeSelf only; this never searches the scene hierarchy.")]
    public List<GameObject> cosmeticParents = new List<GameObject>();
    ...
    {
        foreach (GameObject parent in cosmeticParents)
        {
            ...
            for (int i = 0; i < parentTransform.childCount; i++)
            {
                ...
                if (child.activeSelf) ValidateCosmeticName(child.name);
            }
        }
    }
    ...
    private void CollectActiveCosmetics(List<string> output)
    {
        ...
        foreach (GameObject parent in cosmeticParents)
        {
            ...
            for (int i = 0; i < parent.transform.childCount; i++)
            {
                ...
                if (child.activeSelf) output.Add(child.name);
            }
        }
    }
